<?php
// ============================================================
//  contact.php – Procesare formular de contact (înlocuiește CGI)
// ============================================================

// ── Funcție ajutătoare: sanitizare input ─────────────────────
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($erori)) {
        ...
        if (file_exists($fisier)) {
            ...
            $existente = json_decode($continut, true) ?? [];
        }
        ...
        $mesajSucces = 'Cererea ta a fost trimisă cu succes! Te vom contacta în curând, '
                     . htmlspecialchars($inregistrare['prenume']) . ' '
                     . htmlspecialchars($inregistrare['nume']) . '.';
    }
}

// ── Valori pentru re-populare formular ────────────────────────
$v = [];
  ...
  <div class="sectiune-interior">
    <div class="grila-contact">
      ...
      <div class="formular-contact">
        ...
        <?php if ($mesajSucces): ?>
          <div class="alerta alerta-succes">✅ <?= $mesajSucces ?></div>
        <?php endif; ?>

        <?php if (!empty($erori)): ?>
          <div class="alerta alerta-eroare">
            ❌ Te rugăm să corectezi următoarele erori:
            <ul>
        ...
        <?php if (!$mesajSucces): ?>
        <form action="contact.php" method="POST" onsubmit="return proceseazaFormular()">

          <div class="rand-formular">
            <div class="grup-formular">
              <label for="camp-nume">Nume</label>
              <input type="text" id="camp-nume" name="nume"
                     placeholder="Exemplu: Popovici" value="<?= $v['nume'] ?>">
              <span class="mesaj-eroare" id="eroare-nume"></span>
              <span id="contor-mesaj" class="contor-caractere"
                    style="font-size:0.78rem; color: var(--text-slab);"></span>
            </div>
            <div class="grup-formular">
              <label for="camp-prenume">Prenume</label>
              <input type="text" id="camp-prenume" name="prenume"
                     placeholder="Exemplu: Maria" value="<?= $v['prenume'] ?>">
              <span class="mesaj-eroare" id="eroare-prenume"></span>
            </div>
          </div>

          <div id="preview-nume"
               style="color:var(--verde-mediu);font-weight:600;margin-bottom:8px;"></div>

          <div class="rand-formular">
            <div class="grup-formular">
              <label for="camp-email">Email</label>
              <input type="email" id="camp-email" name="email"
                     placeholder="email@exemplu.com" value="<?= $v['email'] ?>">
              <span class="mesaj-eroare" id="eroare-email"></span>
            </div>
            <div class="grup-formular">
              <label for="camp-telefon">Telefon</label>
              <input type="tel" id="camp-telefon" name="telefon"
                     placeholder="+373 6X XXX XXX" value="<?= $v['telefon'] ?>">
          ...
          <div class="grup-formular">
            ...
            <select id="camp-destinatie" name="destinatie">
              ...
              <?php
              $optiuni = ['Paris, Franța','Roma, Italia','Tokyo, Japonia',
                          'Maldive','New York, SUA','Bali, Indonezia','Altă destinație'];
              // Adaugă dinamic destinațiile din JSON
          ...
          <div class="grup-formular">
            ...
            <input type="date" id="camp-data" name="data_plecare"
                   min="<?= $aziMin ?>" value="<?= $v['data_plecare'] ?>">
            <span class="mesaj-eroare" id="eroare-data"></span>
          </div>

          <div class="grup-formular">
            <label for="camp-persoane">Număr de persoane</label>
            <input type="number" id="camp-persoane" name="persoane" class="input-numar"
                   min="1" max="20" placeholder="Ex: 2" value="<?= $v['persoane'] ?>">
            <span class="mesaj-eroare" id="eroare-persoane"></span>
          </div>

          <div class="grup-formular">
            <label for="camp-mesaj">Mesaj</label>
            <textarea rows="5" id="camp-mesaj" name="mesaj"
              placeholder="Spune-ne ce fel de vacanță îți dorești..."><?= $v['mesaj'] ?></textarea>
      ...
      <div class="info-contact">
        ...
        <div class="rand-info">
          ...
          <div class="text-info">
            ...
            Bd. Turismului nr. 12, Etaj 3<br>Chișinău, Republica Moldova
          </div>
        </div>
        <div class="rand-info">
          <div class="icona-info">📞</div>
          <div class="text-info">
            ...
            <a href="tel:+37322000000">+373 22 000 000</a><br>
            <a href="tel:+37369000000">+373 69 000 000</a>
          </div>
        </div>
        <div class="rand-info">
          <div class="icona-info">✉</div>
          <div class="text-info">
            <strong>EMAIL</strong>
            <a href="mailto:info@exploralumea.md">info@exploralumea.md</a>
          </div>
        </div>
        <div class="rand-info">
          <div class="icona-info">🌐</div>
          <div class="text-info">
            ...
            <a href="index.html">www.exploralumea.md</a>
          </div>
        </div>
        ...
        <div class="tabel-program">
          <div class="program-antet">
            <span>Zi</span><span>Program</span><span>Status</span>
          </div>
          <div class="program-rand">
            <span>Luni – Vineri</span><span>09:00 – 18:00</span>
            <span class="deschis">✔ Deschis</span>
          </div>
          <div class="program-rand">
            <span>Sâmbătă</span><span>10:00 – 15:00</span>
            <span class="deschis">✔ Deschis</span>
          </div>
          <div class="program-rand">
            <span>Duminică</span><span>–</span>
            <span class="inchis">✘ Închis</span>
          </div>
        </div>
